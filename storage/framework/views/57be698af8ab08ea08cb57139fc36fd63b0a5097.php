...
<head>
    ...
    <script src="<?php echo e(URL::asset('js/controller.js')); ?>"></script>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a style="background-color: #222D32" href="index2.html" class="logo">
            ...
            <span class="logo-mini"><b>Us</b>P</span>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a data-toggle="modal" data-target="#confirm-register" href="#" class="btn btn-default btn-flat"><i class="fa fa-btn fa-gear"></i> Setting</a>
                                </div>
                                <div class="pull-right">
                                    <a href="<?php echo e(url('customer/logout')); ?>" class="btn btn-default btn-flat"><i class="fa fa-btn fa-sign-out"></i> Logout</a>
                                </div>
                            </li>
                        </ul>
                    </li>
