...
<head>
    ...
    <script src="<?php echo e(URL::asset('js/AdminController.js')); ?>"></script>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="<?php echo e(url('/logout')); ?>" class="btn btn-default btn-flat"><i class="fa fa-btn fa-sign-out"></i> Logout</a>
                                </div>
                            </li>
                        </ul>
                    </li>
