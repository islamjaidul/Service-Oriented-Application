...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link rel="stylesheet" href="<?php echo e(URL::asset('bootstrap_framework/css/bootstrap.min.css')); ?>" type="text/css">

    <!-- Custom Fonts -->
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800' rel='stylesheet' type='text/css'>
    <link href='https://fonts.googleapis.com/css?family=Merriweather:400,300,300italic,400italic,700,700italic,900,900italic' rel='stylesheet' type='text/css'>
    <link rel="stylesheet" href="<?php echo e(URL::asset('dist/font-awesome/css/font-awesome.min.css')); ?>" type="text/css">

    <!-- Plugin CSS -->
    <link rel="stylesheet" href="<?php echo e(URL::asset('dist/css/magnific-popup.css')); ?>" type="text/css">

    <!-- Custom CSS -->
    <link rel="stylesheet" href="<?php echo e(URL::asset('dist/css/creative.min.css')); ?>" type="text/css">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="<?php echo e(url('customer/register')); ?>">Sign up</a>
                    </li>
                    <li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>Generate DOCX</h3>
                        <p class="text-muted">Also can be generated DOCX by our API</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>Generate CSV</h3>
                        <p class="text-muted">And also can be generated CSV by our API</p>
                    </div>
                </div>
            </div>
        </div>
...
echo $obj->optionData($option)
    ...
    <script src="<?php echo e(URL::asset('dist/js/bootstrap.min.js')); ?>"></script>

    <!-- Plugin JavaScript -->
    <script src="<?php echo e(URL::asset('dist/js/scrollreveal.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('dist/js/jquery.easing.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('dist/js/jquery.fittext.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('dist/js/jquery.magnific-popup.min.js')); ?>"></script>

    <!-- Custom Theme JavaScript -->
    <script src="<?php echo e(URL::asset('dist/js/creative.js')); ?>"></script>
